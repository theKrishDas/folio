...
date: "2025-04-03"
summary: "Writing about me for the folio"
---
...
the popularity of its themes ecosystem — use any VS Code theme you want! `inline-code`.
...
```js /floatingStyles/  title="page/this.js"
import { useFloating } from "@floating-ui/react";
